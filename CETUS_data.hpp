...
//Room loadRoom(std::string location, std::map<std::string, Item> *itemMap);//creates Room from .txt file.  MAY NEED TO ACCESS MAP OF ITEMS
//Player loadPlayer(std::string location);//create Player from .txt file
